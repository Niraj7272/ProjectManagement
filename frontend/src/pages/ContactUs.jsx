    ...
    <div>
      <div className=" bg-white h-[60rem] border-1 border-blue-500 w-[80rem] ml-[2rem]">
        ...
        <div className="mt-[22rem] ml-[5rem] font-semibold text-gray-600">
          ...
          <div className="flex">
            <img src="src/assets/twitter (1).png" alt=""  className="h-[1.7rem]"/>
            <img src="src/assets/linkedin.png" alt="" className="h-[1.7rem] ml-[1rem]"/>
            <img src="src/assets/instagram.png" alt="" className="h-[2.2rem] ml-[1rem]"/>
          </div>
        </div>
        </div>
